...
class vqa_dataset(Dataset):
    ...
    def __getitem__(self, index):    
        ...
        if self.split == 'test':
            ...
            image_path = os.path.join('coco', ann['image'])  
            ...
            if ann['dataset']=='vqa':
                ...
                image = load_decompress_img_from_lmdb_value(
        ...
        if self.split == 'test':
            ...
            if ann['dataset']=='vqa':               
                ...
                answers = list(answer_weight.keys()) # ['str1', 'str2', 'str3']
                weights = list(answer_weight.values())

            elif ann['dataset']=='vg':
                answers = [ann['answer']] #['str']
                weights = [0.2]  
