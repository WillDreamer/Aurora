from CP.med import BertConfig, BertModel, BertLMHeadModel
        ...
        if train:                               
            ...
            if inference=='generate':
                ...
                max_ids = self.rank_answer(question_output.last_hidden_state, question.attention_mask, 
                                           answer.input_ids, answer.attention_mask, k_test, CP_U=self.CP_U, CP_V=self.CP_V, CP_C=self.CP_C) 
                return max_ids
 
    def rank_answer(self, question_states, question_atts, answer_ids, answer_atts, k, CP_U, CP_V, CP_C):
